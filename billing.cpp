...
bill<<"-------------------------------------------------------------------------------------"<<endl;
bill<<"                                     SF No.153                                       "<<endl;
bill<<"                                   Vasanth Nagar,                                    "<<endl;
bill<<"                                     M G Road,                                       "<<endl;
bill<<"                                    Sulur Taluk,                                     "<<endl;
bill<<"                                 Coimbatore-641006                                   "<<endl;
bill<<"---------------------------------Phone:99999 00000-----------------------------------"<<endl;
...
//To search by the name of the item
int cart::search_by_name()
{
    ...
    do
    {
        ...
        cout << endl;
        cout << endl;
        scount+=s.display_products_minimal(name);  //counts the number of records
